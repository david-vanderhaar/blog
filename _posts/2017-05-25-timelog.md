...
* Wikipedia Search Game - Input a start word and a destination word. Count how many clicks to reach word.
* Breakout Games Adventure App - Send folks on an adventure around town using their phones and a code purchased from Breakoutgames
